...
export const development = [
  ...
  },
  {
    ...
    images: [
      ...
      { src: "/assets/projects/therapist-funnel/images/img2.webp", alt: "Client download + form" },
      { src: "/assets/projects/therapist-funnel/images/img3.webp", alt: "Redeem code + scheduling" },
      { src: "/assets/projects/therapist-funnel/images/img4.webp", alt: "Calendar + Meet automation" },
      { src: "/assets/projects/therapist-funnel/images/img5.webp", alt: "Confirmation + follow-up" },
      { src: "/assets/projects/therapist-funnel/images/img6.webp", alt: "Confirmation + follow-up" },
      { src: "/assets/projects/therapist-funnel/images/img7.webp", alt: "Confirmation + follow-up" },
      { src: "/assets/projects/therapist-funnel/images/img8.webp", alt: "Confirmation + follow-up" },
      { src: "/assets/projects/therapist-funnel/images/img9.webp", alt: "Confirmation + follow-up" },
      { src: "/assets/projects/therapist-funnel/images/img10.webp", alt: "Confirmation + follow-up" },
      { src: "/assets/projects/therapist-funnel/images/img11.webp", alt: "Confirmation + follow-up" },
      { src: "/assets/projects/therapist-funnel/images/img12.webp", alt: "Confirmation + follow-up" },
    ],
    links: [
