...
const PRIMARY_LINKS = fields.map((field) => ({
  ...
  const navBackgroundClass = useMemo(
    () =>
      isScrolled || isMenuOpen
        ? "backdrop-blur-2xl border border-white/15 bg-white/12 shadow-[0_18px_46px_-24px_rgba(15,23,42,0.45)] transition-all duration-300 dark:border-white/10 dark:bg-white/10"
        : "backdrop-blur-2xl border border-white/10 bg-white/10 shadow-[0_14px_38px_-24px_rgba(15,23,42,0.32)] transition-all duration-300 dark:border-white/8 dark:bg-white/8",
    [isScrolled, isMenuOpen],
  );
